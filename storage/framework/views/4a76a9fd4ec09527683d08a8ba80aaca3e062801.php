...
<div class="list blue-back list-flex">
    <div class="profile-image-up">
        ...
        <div class="button-nav">
            <?php
            $isFollow = $follow->where('follower_id', $user->id)
                            ->where('follow_id', auth()->user()->id)
                            ->isNotEmpty();
            ?>
            <button class="radius follow-btn" type="button" data-follower-id="<?php echo e($user->id); ?>"><?php echo e($isFollow ? 'フォロー解除' : 'フォローする'); ?></button>
        </div>
        <div class="column">
            <p><?php echo e($follow_count); ?>フォロー中</p>
            <p class="follower-count"><?php echo e($follower_count); ?>フォロワー</p>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/made/resources/views/content/profile.blade.php ENDPATH**/ ?>